...
## 2026-05-31 - [Fast multiple literal string replacement]
...
**Action:** Use iterative `str.replace` instead of `re.subn` when removing a small list of known literal strings from user input.
