...
def mean_pooling(input_array: NumpyArray, attention_mask: NDArray[np.int64]) -> NumpyArray:
    # Use np.matmul with a mask of shape (Batch, 1, Seq) to avoid instantiating a large intermediate array
    # for broadcasting, which is significantly faster and more memory-efficient.
