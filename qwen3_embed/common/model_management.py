...
class ModelManagement(Generic[T]):
    ...
    def _validate_tar_member(cls, member: tarfile.TarInfo, cache_dir: str) -> None:
        ...
        # SECURITY: Only allow regular files and directories. Symlinks and hardlinks are
        # prohibited to prevent symlink-based path traversal and symlink-as-directory attacks.
