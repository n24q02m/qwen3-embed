...
class TestCustomCrossEncoderRegistration:
    ...
    def test_duplicate_model_raises_case_insensitive(self):
        ...
        TextCrossEncoder.add_custom_model(model_description=description)
        ...
        duplicate_description = BaseModelDescription(
            model="test/duplicate",
            sources=ModelSource(hf="test/duplicate"),
            model_file="onnx/model.onnx",
            description="",
        ...
        with pytest.raises(ValueError, match="already registered"):
            TextCrossEncoder.add_custom_model(model_description=duplicate_description)
