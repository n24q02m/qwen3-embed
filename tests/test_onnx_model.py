...
def test_load_defaults(model: ConcreteOnnxModel, mock_ort):
    ...
    model._load_onnx_model(Path("dummy"), "model.onnx", config=OnnxSessionConfig(threads=None))
...
def test_load_cuda_explicit(model: ConcreteOnnxModel, mock_ort):
    ...
    model._load_onnx_model(Path("dummy"), "model.onnx", config=OnnxSessionConfig(threads=None, cuda=True))
...
def test_load_cuda_auto_available(model: ConcreteOnnxModel, mock_ort):
    ...
    model._load_onnx_model(Path("dummy"), "model.onnx", config=OnnxSessionConfig(threads=None, cuda=Device.AUTO))
...
def test_load_explicit_providers(model: ConcreteOnnxModel, mock_ort):
    ...
    model._load_onnx_model(
        Path("dummy"), "model.onnx", config=OnnxSessionConfig(threads=None, providers=["CUDAExecutionProvider"])
    )
...
def test_load_threads(model: ConcreteOnnxModel, mock_ort):
    ...
    model._load_onnx_model(Path("dummy"), "model.onnx", config=OnnxSessionConfig(threads=4))
...
def test_load_parallel_execution(model: ConcreteOnnxModel, mock_ort):
    ...
    model._load_onnx_model(Path("dummy"), "model.onnx", config=OnnxSessionConfig(threads=None, parallel_execution=True))
