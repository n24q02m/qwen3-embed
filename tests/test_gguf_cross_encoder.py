...
class TestRerank:
    ...
    def test_rerank_uses_default_instruction(self):
        ...
        model = _make_model()
        model._score_text = MagicMock(return_value=0.9)  # type: ignore[invalid-assignment]  # type: ignore

        list(model.rerank("q", ["doc"]))

        call_arg = model._score_text.call_args[0][0]  # type: ignore[unresolved-attribute]  # type: ignore
...
class TestRerankPairs:
    ...
    def test_rerank_pairs_uses_default_instruction(self):
        ...
        model = _make_model()
        model._score_text = MagicMock(return_value=0.7)  # type: ignore[invalid-assignment]  # type: ignore
    ...
    def test_rerank_pairs_formats_input_correctly(self):
        ...
        model = _make_model()
        model._score_text = MagicMock(return_value=0.5)  # type: ignore[invalid-assignment]  # type: ignore
