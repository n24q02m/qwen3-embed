...
class TestOnnxTextCrossEncoderLoadOnnxModel:
    ...
    def test_delegates_to_load_onnx_model(
        ...
        assert config_arg.threads == enc.threads
        assert config_arg.providers == enc.providers
        assert config_arg.cuda == enc.cuda
        assert config_arg.device_id == enc.device_id
        assert config_arg.extra_session_options == enc._extra_session_options
