...
class TestLastTokenPool:
    ...
    def test_last_token_pool_right_padding_returns_correct_last_token(self):
    ...
    def test_last_token_pool_left_padding_returns_correct_last_token(self):
    ...
    def test_last_token_pool_single_token_returns_correct_last_token(self):
    ...
    def test_last_token_pool_batch_size_one_returns_correct_values(self):
...
class TestPoolingType:
    ...
    def test_pooling_type_has_last_token_value(self):
        assert hasattr(PoolingType, "LAST_TOKEN")
        assert PoolingType.LAST_TOKEN == "LAST_TOKEN"

    def test_pooling_type_contains_expected_members(self):
...
class TestNormalize:
    ...
    def test_normalize_vectors_returns_unit_norm(self):
    ...
    def test_normalize_zero_vector_handles_gracefully(self):
