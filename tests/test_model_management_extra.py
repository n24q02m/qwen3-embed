...
class TestModelManagementExtra:
    ...
    def test_decompress_blocks_symlinks_and_hardlinks(self, tmp_path):
        """Test that symlinks and hardlinks are always blocked during extraction."""
