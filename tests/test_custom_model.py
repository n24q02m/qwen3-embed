...
class TestCustomModelRegistration:
    ...
    def test_add_custom_model_cls_pooling_registers_correctly(self):
    ...
    def test_add_custom_model_mean_pooling_registers_correctly(self):
        TextEmbedding.add_custom_model(
    ...
    def test_add_custom_model_last_token_pooling_registers_correctly(self):
        TextEmbedding.add_custom_model(
    ...
    def test_add_custom_model_duplicate_raises_value_error(self):
        TextEmbedding.add_custom_model(
