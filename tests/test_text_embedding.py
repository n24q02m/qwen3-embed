...
def test_embedding_size_property(mocked_text_embedding):
    ...
    with patch.object(TextEmbedding, "get_embedding_size", return_value=123):
        ...
        TextEmbedding.get_embedding_size.reset_mock() # type: ignore[unresolved-attribute]
        assert te.embedding_size == 123
        TextEmbedding.get_embedding_size.assert_not_called() # type: ignore[unresolved-attribute]
