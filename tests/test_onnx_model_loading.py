...
def test_load_defaults(model: ConcreteOnnxModel, mock_ort):
    ...
    config = OnnxLoadConfig(model_dir=Path("dummy"), model_file="model.onnx", threads=None)
    model._load_onnx_model(config)
...
def test_load_threads(model: ConcreteOnnxModel, mock_ort):
    ...
    config = OnnxLoadConfig(model_dir=Path("dummy"), model_file="model.onnx", threads=4)
    model._load_onnx_model(config)
