...
def test_load_defaults(model: ConcreteOnnxModel, mock_ort):
    ...
    model._load_onnx_model(
        OnnxLoadConfig(model_dir=Path("dummy"), model_file="model.onnx", threads=None)
    )
...
def test_load_cuda_explicit(model: ConcreteOnnxModel, mock_ort):
    ...
    model._load_onnx_model(
        OnnxLoadConfig(model_dir=Path("dummy"), model_file="model.onnx", threads=None, cuda=True)
    )
...
def test_load_threads(model: ConcreteOnnxModel, mock_ort):
    ...
    model._load_onnx_model(
        OnnxLoadConfig(model_dir=Path("dummy"), model_file="model.onnx", threads=4)
    )
