...
from qwen3_embed.common.onnx_model import OnnxModel, OnnxModelConfig, OnnxOutputContext
...
def test_load_defaults(model: ConcreteOnnxModel, mock_ort):
    ...
    model._load_onnx_model(OnnxModelConfig(Path("dummy"), "model.onnx", threads=None))
...
def test_load_cuda_explicit(model: ConcreteOnnxModel, mock_ort):
    ...
    model._load_onnx_model(OnnxModelConfig(Path("dummy"), "model.onnx", threads=None, cuda=True))
...
def test_load_cuda_auto_available(model: ConcreteOnnxModel, mock_ort):
    ...
    model._load_onnx_model(OnnxModelConfig(Path("dummy"), "model.onnx", threads=None, cuda=Device.AUTO))
...
def test_load_explicit_providers(model: ConcreteOnnxModel, mock_ort):
    ...
    model._load_onnx_model(
        OnnxModelConfig(Path("dummy"), "model.onnx", threads=None, providers=["CUDAExecutionProvider"])
    )
...
def test_load_threads(model: ConcreteOnnxModel, mock_ort):
    ...
    model._load_onnx_model(OnnxModelConfig(Path("dummy"), "model.onnx", threads=4))
