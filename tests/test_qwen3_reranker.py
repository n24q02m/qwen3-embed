...
class TestQwen3CrossEncoderRegistry:
    ...
    def test_registry_contains_qwen3_cross_encoder(self):
    ...
    def test_list_supported_models_contains_qwen3_models(self):
    ...
    def test_model_description_qwen3_reranker_has_correct_fields(self):
...
class TestQwen3ChatTemplate:
    ...
    def test_format_rerank_input_default_args_returns_chat_template(self):
    ...
    def test_format_rerank_input_custom_instruction_returns_custom_template(self):
        result = Qwen3CrossEncoder._format_rerank_input(
            query="q",
            document="d",
...
class TestYesNoScoring:
    ...
    def test_compute_yes_no_scores_strong_yes_logit_returns_high_score(self):
    ...
    def test_compute_yes_no_scores_strong_no_logit_returns_low_score(self):
    ...
    def test_compute_yes_no_scores_equal_logits_returns_half_score(self):
    ...
    def test_compute_yes_no_scores_batch_input_returns_correct_scores(self):
    ...
    def test_compute_yes_no_scores_large_logits_returns_stable_score(self):
...
class TestTokenConstants:
    ...
    def test_token_constants_ids_are_positive(self):
        assert TOKEN_YES_ID > 0
        assert TOKEN_NO_ID > 0

    def test_token_constants_ids_are_different(self):
